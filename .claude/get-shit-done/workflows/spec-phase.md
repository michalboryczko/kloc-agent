...
```bash
INIT=$(node "/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/templates/spec.md.
