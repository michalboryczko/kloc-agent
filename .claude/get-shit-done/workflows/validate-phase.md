...
```
Agent(
  prompt="Read /Users/michal/dev/ai/kloc/kloc-agent/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/templates/VALIDATION.md`
