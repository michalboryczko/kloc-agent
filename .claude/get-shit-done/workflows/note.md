...
- **Global scope**: `/Users/michal/dev/ai/kloc/kloc-agent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/michal/dev/ai/kloc/kloc-agent/.claude/notes/`)
...
2. Glob `/Users/michal/dev/ai/kloc/kloc-agent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/michal/dev/ai/kloc/kloc-agent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/michal/dev/ai/kloc/kloc-agent/.claude/notes/` — works in any directory
