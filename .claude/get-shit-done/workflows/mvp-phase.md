...
<required_reading>
@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/user-story-template.md
@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/spidr-splitting.md
@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
