...
```markdown
Read /Users/michal/dev/ai/kloc/kloc-agent/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/michal/dev/ai/kloc/kloc-agent/.claude/agents/gsd-ui-checker.md for instructions.
