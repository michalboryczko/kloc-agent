...
INSTALL_JS_GLOBAL="/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
