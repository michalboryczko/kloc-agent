...
<reference>
@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/user-profiling.md` to load:
