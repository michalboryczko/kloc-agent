...
Use template from `/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/templates/UI-SPEC.md`
