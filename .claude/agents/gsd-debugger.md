...
<required_reading>
@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/michal/dev/ai/kloc/kloc-agent/.claude
                  → checks /Users/michal/dev/ai/kloc/kloc-agent/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done
                  → writes to /Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/hooks/
...
@/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/references/common-bug-patterns.md
