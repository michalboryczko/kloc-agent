...
Reference full template: `/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/templates/state.md`.
