...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/michal/dev/ai/kloc/kloc-agent/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/Users/michal/dev/ai/kloc/kloc-agent/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/Users/michal/dev/ai/kloc/kloc-agent/.claude/commands/gsd
AGENTS_DIR=/Users/michal/dev/ai/kloc/kloc-agent/.claude/agents
```
...
<execution_context>
Surface state file: `/Users/michal/dev/ai/kloc/kloc-agent/.claude/skills/.gsd-surface.json`
Install profile marker: `/Users/michal/dev/ai/kloc/kloc-agent/.claude/skills/.gsd-profile`
Engine module: `/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/michal/dev/ai/kloc/kloc-agent/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
