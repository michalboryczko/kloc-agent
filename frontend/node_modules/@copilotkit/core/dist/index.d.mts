...
declare class SuggestionEngine {
   ...
   */
  reloadSuggestions(agentId: string, consumerAgent?: AbstractAgent): void;
  /**
...
declare class StateManager {
   ...
   */
  subscribeToAgent(agent: AbstractAgent, /** @param isClone When true, uses a composite `agentId:threadId` key for per-thread isolation. */{
    isClone
  }?: {
    isClone?: boolean;
  }): void;
