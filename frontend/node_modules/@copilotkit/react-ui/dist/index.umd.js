...
//#region src/components/chat/Window.tsx
	const Window = ({ children, clickOutsideToClose, shortcut, hitEscapeToClose }) => {
		...
		const handleClickOutside = (0, react.useCallback)((event) => {
			...
			const parentElement = (_windowRef$current = windowRef.current) === null || _windowRef$current === void 0 ? void 0 : _windowRef$current.parentElement;
			let className = "";
		...
		const handleKeyDown = (0, react.useCallback)((event) => {
			...
			const isDescendantOfWrapper = (_windowRef$current2 = windowRef.current) === null || _windowRef$current2 === void 0 ? void 0 : _windowRef$current2.contains(target);
...
//#region src/hooks/use-copy-to-clipboard.tsx
	function useCopyToClipboard({ timeout = 2e3 }) {
		...
		const copyToClipboard = (value) => {
			...
			if (typeof window === "undefined" || !((_navigator$clipboard = navigator.clipboard) === null || _navigator$clipboard === void 0 ? void 0 : _navigator$clipboard.writeText)) return;
			if (!value) return;
	...
	const defaultComponents = {
		...
		code({ children, className, inline, ...props }) {
			if (Array.isArray(children) && children.length) {
				...
				children[0] = (children === null || children === void 0 ? void 0 : children[0]).replace("`▍`", "▍");
			}
...
//#region src/components/chat/messages/AssistantMessage.tsx
	const AssistantMessage = (props) => {
		var _message$generativeUI, _message$generativeUI2, _message$generativeUI3;
		...
		const content = (message === null || message === void 0 ? void 0 : message.content) || "";
		const subComponent = (_message$generativeUI = message === null || message === void 0 || (_message$generativeUI2 = message.generativeUI) === null || _message$generativeUI2 === void 0 ? void 0 : _message$generativeUI2.call(message)) !== null && _message$generativeUI !== void 0 ? _message$generativeUI : props.subComponent;
		const subComponentPosition = (_message$generativeUI3 = message === null || message === void 0 ? void 0 : message.generativeUIPosition) !== null && _message$generativeUI3 !== void 0 ? _message$generativeUI3 : "after";
...
//#region src/components/chat/messages/RenderMessage.tsx
	function RenderMessage({ UserMessage: UserMessage$3 = UserMessage, AssistantMessage: AssistantMessage$3 = AssistantMessage, ImageRenderer: ImageRenderer$2 = ImageRenderer, ...props }) {
		...
		switch (message.role) {
			...
			case "assistant":
				var _message$generativeUI;
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssistantMessage$3, {
					"data-message-role": "assistant",
					subComponent: (_message$generativeUI = message.generativeUI) === null || _message$generativeUI === void 0 ? void 0 : _message$generativeUI.call(message),
					rawData: message,
					message,
					messages,
					...
					isCurrentMessage,
					onRegenerate: () => onRegenerate === null || onRegenerate === void 0 ? void 0 : onRegenerate(message.id),
					onCopy,
					onThumbsUp,
					onThumbsDown,
					feedback: (messageFeedback === null || messageFeedback === void 0 ? void 0 : messageFeedback[message.id]) || null,
...
/**
	...
	*/
	const LegacyRenderMessage = ({ message, messages, inProgress, index, isCurrentMessage, actionResult, AssistantMessage, UserMessage, ImageRenderer, onRegenerate, onCopy, onThumbsUp, onThumbsDown, markdownTagRenderers, legacyProps }) => {
		...
		const deprecatedMessage = (_aguiToGQL$ = (0, _copilotkit_runtime_client_gql.aguiToGQL)(message)[0]) !== null && _aguiToGQL$ !== void 0 ? _aguiToGQL$ : void 0;
...
//#region src/components/chat/Input.tsx
	...
	const Input = ({ inProgress, onSend, chatReady = false, onStop, onUpload, hideStopButton = false }) => {
		var _copilotContext$copil;
		const context = useChatContext();
		const copilotContext = (0, _copilotkit_react_core.useCopilotContext)();
		const showPoweredBy = !((_copilotContext$copil = copilotContext.copilotApiConfig) === null || _copilotContext$copil === void 0 ? void 0 : _copilotContext$copil.publicApiKey);
...
//#region src/components/chat/Suggestion.tsx
	function Suggestion({ title, onClick, partial, className }) {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
			...
			className: `suggestion ${className !== null && className !== void 0 ? className : ""} ${partial ? "loading" : ""}`,
	...
	function Suggestions({ suggestions, onSuggestionClick, isLoading }) {
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: suggestions.map((suggestion, index) => {
				var _ref, _suggestion$isLoading;
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Suggestion, {
					title: suggestion.title,
					message: suggestion.message,
					partial: (_ref = (_suggestion$isLoading = suggestion.isLoading) !== null && _suggestion$isLoading !== void 0 ? _suggestion$isLoading : suggestion.partial) !== null && _ref !== void 0 ? _ref : isLoading,
	...
	*/
	function CopilotChat({ instructions, suggestions = "auto", onSubmitMessage, makeSystemMessage, disableSystemMessage, onInProgress, onStopGeneration, onReloadMessages, onRegenerate, onCopy, onThumbsUp, onThumbsDown, markdownTagRenderers, Messages: Messages$2 = Messages, RenderMessage: RenderMessage$1 = RenderMessage, RenderSuggestionsList = Suggestions, Input: Input$2 = Input, className, icons, labels, AssistantMessage: AssistantMessage$2 = AssistantMessage, UserMessage: UserMessage$2 = UserMessage, ImageRenderer: ImageRenderer$1 = ImageRenderer, ErrorMessage, imageUploadsEnabled, inputFileAccept = "image/*", hideStopButton, observabilityHooks, renderError, onError, RenderTextMessage, RenderActionExecutionMessage, RenderAgentStateMessage, RenderResultMessage, RenderImageMessage }) {
		...
		const triggerObservabilityHook = (0, react.useCallback)((hookName, ...args) => {
			if (publicApiKey && (observabilityHooks === null || observabilityHooks === void 0 ? void 0 : observabilityHooks[hookName])) observabilityHooks[hookName](...args);
			if ((observabilityHooks === null || observabilityHooks === void 0 ? void 0 : observabilityHooks[hookName]) && !publicApiKey) {
		...
		const triggerChatError = (0, react.useCallback)((error, operation, originalError) => {
			...
			if (publicApiKey && (observabilityHooks === null || observabilityHooks === void 0 ? void 0 : observabilityHooks.onError)) observabilityHooks.onError(errorEvent);
			if ((observabilityHooks === null || observabilityHooks === void 0 ? void 0 : observabilityHooks.onError) && !publicApiKey) {
				setBannerError(new _copilotkit_shared.CopilotKitError({
		...
		(0, react.useEffect)(() => {
			...
			return () => {
				removeInternalErrorHandler === null || removeInternalErrorHandler === void 0 || removeInternalErrorHandler(id);
			};
		}, [
			triggerChatError,
	...
	function WrappedCopilotChat({ children, icons, labels, className }) {
		if (!react.default.useContext(ChatContext)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChatContextProvider, {
			...
			setOpen: () => {},
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: `copilotKitChat ${className !== null && className !== void 0 ? className : ""}`,
				children
			})
		});
	...
	const CopilotModal = ({ instructions, defaultOpen = false, clickOutsideToClose = true, hitEscapeToClose = true, onSetOpen, onSubmitMessage, onStopGeneration, onReloadMessages, shortcut = "/", icons, labels, makeSystemMessage, onInProgress, Window: Window$1 = Window, Button: Button$1 = Button, Header: Header$1 = Header, Messages: Messages$1 = Messages, Input: Input$1 = Input, AssistantMessage: AssistantMessage$1 = AssistantMessage, UserMessage: UserMessage$1 = UserMessage, onThumbsUp, onThumbsDown, onCopy, onRegenerate, markdownTagRenderers, className, children, observabilityHooks, ...props }) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChatContextProvider, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CopilotModalInner, {
				observabilityHooks,
				onSetOpen,
				clickOutsideToClose: clickOutsideToClose !== null && clickOutsideToClose !== void 0 ? clickOutsideToClose : true,
				hitEscapeToClose: hitEscapeToClose !== null && hitEscapeToClose !== void 0 ? hitEscapeToClose : true,
				shortcut: shortcut !== null && shortcut !== void 0 ? shortcut : "/",
				className,
				Window: Window$1,
				Button: Button$1,
				Header: Header$1,
	...
	*/
	function CopilotSidebar(props) {
		...
		const onSetOpen = (open) => {
			var _props$onSetOpen;
			(_props$onSetOpen = props.onSetOpen) === null || _props$onSetOpen === void 0 || _props$onSetOpen.call(props, open);
