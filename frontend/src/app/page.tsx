  ...
  return (
    <Shell>
      ...
      <main className="flex-1 min-w-0 flex flex-col bg-[var(--color-canvas)]">
        <header className="flex items-center justify-end px-5 py-3 border-b border-[var(--color-line)] shrink-0">
          <ThemeToggle />
        </header>
        <div className="flex-1 grid place-items-center px-6">
          <div className="text-center max-w-[420px]">
            <div className="w-10 h-10 mx-auto rounded-[8px] bg-[var(--color-chip-bg)] grid place-items-center mb-4">
              <svg
                width={18}
                height={18}
                viewBox="0 0 24 24"
